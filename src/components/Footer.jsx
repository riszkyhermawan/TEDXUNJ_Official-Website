...
const Footer = () => {
  return (
    <div className="p-6 lg:p-2 w-screen max-w-screen flex flex-col bg-red-600 bg-opacity-50 gap-4 md:flex-row md:justify-center md:items-center lg:gap-16 xl:gap-56 relative overflow-x-hidden">
